...
export const payment = sqliteTable("payment", {
	...
	rejected: integer({ mode: "boolean" }).default(false).notNull(),
	createdAt: integer("created_at"),
});
...
export const eventPhase = sqliteTable("event_phase", {
	...
	requiresPreviousPhase: integer("requires_previous_phase", { mode: "boolean" }).default(true),
	instructions: text(),
	createdAt: integer("created_at").notNull(),
	updatedAt: integer("updated_at").notNull(),
});
...
export const phaseForm = sqliteTable("phase_form", {
	...
	description: text(),
	formSchema: text("form_schema").notNull(),
	allowMultiple: integer("allow_multiple", { mode: "boolean" }).default(false),
